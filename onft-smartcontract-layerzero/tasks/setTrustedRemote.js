...
const { CHAININFO } = require("../../LayerZero_onft_zksync/constants/chains");
...
module.exports = async function (taskArgs, hre) {
    ...
    let remoteAddress;
    if (taskArgs.targetNetwork == "zksync" || taskArgs.targetNetwork == "zksync-testnet") {
        remoteAddress = CHAININFO[taskArgs.targetNetwork].address;
    } else {
